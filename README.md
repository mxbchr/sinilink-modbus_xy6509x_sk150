...
* XY-SK120 (untested)
* XY-SK60 (untested)
* Other similar Sinlink PSUs may work if they use the same Modbus protocol/registers, but you’ll likely need to add a model-specific substitutions table for scaling/limits.
